...
return(
 ...
 <div
  ...
  style={{ backgroundImage: `url('bibliotecabg.png')` }}>
  ...
  <div className="hero-content text-neutral-content text-center">
    <div className="max-w-md flex justify-center flex-col items-center">
      ...
      <p className="text-lg md:text-xl px-2 py-2 rounded max-w-2xl">
       ...
       <img src="/host1.png" alt="Aguará Guazú" className="w-42 h-60  object-contain mt-4 drop-shadow-lg  "
      />
      <div className="mt-6 flex gap-4">
        <Link href="/register" className="bg-orange-400 hover:bg-yellow-500 text-white font-semibold px-6 py-2 rounded-full shadow">
        Empezar
        </Link>
